...
[`@aws-sdk/client-cloudhsm`](https://www.npmjs.com/package/@aws-sdk/client-cloudhsm/v/3.154.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudhsm@3.154.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AgY0uPTrkyuGs02VhA7BbJCPCgmy/RQUS5PL6TINfw44go2EYGokol/QmCAHp4kO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudhsm": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudhsm@3.154.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudhsm@3.154.0/index.min.mjs": "sha384-AgY0uPTrkyuGs02VhA7BbJCPCgmy/RQUS5PL6TINfw44go2EYGokol/QmCAHp4kO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloudhsm/blob/refs/tags/3.154.0/LICENSE
```
